...
namespace DotNetty.Codecs.MqttFx
{
    ...
    public sealed class MqttDecoder : ReplayingDecoder<MqttDecoder.ParseState>
    {
        ...
        private Packet DecodePacketInternal(IByteBuffer buffer, byte headerFlags, ref int remainingLength)
        {
            //var fixedHeader = new FixedHeader(packetSignature, remainingLength);
            FixedHeader fixedHeader = default;
            fixedHeader.Decode(headerFlags);
            ...
            remainingLength = packet.FixedHeader.RemaingLength;
            return packet;
        }
